  ...
  <body>
    ...
    <div class="container mt-3">
      ...
      <div class="mb-2 row">
        ...
        <input required type="number" class="form-control" name="nik" id="nik" placeholder="Ex : 33700569..."  value="<?php echo $nik; ?>">
        </div>
      <div class="mb-2 row">
        <label for="nama" class="col-sm-2 col-form-label">Nama Lengkap</label>
        <input required type="text" class="form-control" name="nama_lengkap" id="nama" placeholder="Ex : Zachary Luthfy Riszqon" value="<?php echo $nama_lengkap; ?>" />
      </div>
      <div class="mb-2 row">
        <label for="umur" class="col-sm-2 col-form-label">Umur</label>
        <input required type="number" class="form-control" name="umur" id="umur" placeholder="Ex : 17" value="<?php echo $umur; ?>" />
      </div>
      <div>
      ...
      <div class="mb-2 row">
        ...
        <textarea required class="form-control" placeholder="Ex : Jl. Achmad Yani Mo 89 Jakarta Pusat" name="alamat" id="textarea"><?php echo $alamat; ?></textarea>
      </div>
      <div class="mb-2 row mt-2">
