...
<body>
<div class="container">
			<h2 class="mt-3 mb-3">Data Table of some Famous people in the World</h2>
        ...
        <div class="col">
          <a href="index.php" type="button" class="btn btn-danger mt-3 mb-3"> <i class="fa fa-arrow-left" aria-hidden="true"></i> Kembali </a>
        </div>
